...
// var domain = 'http://192.168.2.39:8000' // 统一接口域名，测试环境
// var wsDomain = 'ws://192.168.2.39:8000' // 统一接口域名，测试环境

var domain = 'http://mall4cloud.local:8000' // 统一接口域名，测试环境
var wsDomain = 'ws://mall4cloud.local:8000' // 统一接口域名，测试环境

var picDomain = 'http://img-test.gz-yami.com/' // 图片域名

// 访问文件存储资源的url 对应阿里云的Bucket域名
var resourcesUrl = 'http://mall4cloud.miniio:9000/mall4cloud'
